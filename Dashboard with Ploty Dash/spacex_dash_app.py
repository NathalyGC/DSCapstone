...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(spacex_df, values=values, 
        ...
        values=filtered_df['class'].value_counts().to_list()
        fig = px.pie(filtered_df, values=values,
        names=spacex_df['class'].unique().tolist(),
...
def get_scatter(entered_site,payload):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df2=filtered_df2[spacex_df["Payload Mass (kg)"].between(payload[0],payload[1])]
